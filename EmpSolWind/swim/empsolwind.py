...
# EmpSolWind:  Empirical Solar Wind Models
#
# Authors:
#           Savir Basil
#           Ronald M. Caplan
...
#
#    WSA is from CORHEL
#    WSA2 is from [McGregoretal 2011]
#
# Version 1.0.0
#
...
def argParsing():
    ...
    ## Model type
    parser.add_argument("-model",type=str,help='Model type. Allowed model types are: wsa, wsa2, psi')
